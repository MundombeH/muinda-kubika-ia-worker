...
from worker.config import GROK_API_KEY, GROK_MODEL
from worker.providers.base import IAProvider, ProviderError

logger = logging.getLogger(__name__)


class GrokProvider(IAProvider):
    ...
    def generate(self, prompt: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if text:
                logger.error(
                    "Grok resposta bruta (primeiros 500 chars): %s", text[:500]
                )
            logger.exception("Grok falhou")
